...
public class InfoPaginationListFragment extends InfoListFragmentWithoutLogic implements InfoPaginationListView {

    private InfoPaginationListController<InfoPaginationListView> controller;
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        controller = new InfoPaginationListController<>();
    }
