...
public abstract class SimpleListWithCacheControllerDeprecated<O, T extends MVC.View> extends SimpleListController<O, T>
            implements ListWithCacheController<O, T> {

    private boolean dataFromCacheLoaded;

    public SimpleListWithCacheControllerDeprecated() {
